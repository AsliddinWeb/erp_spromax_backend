...
def upgrade() -> None:
    ...
    op.add_column('scrap_stock', sa.Column('stock_type', sa.String(length=20), nullable=False))
    ...
    op.add_column('scrap_stock_transactions', sa.Column('stock_type', sa.String(length=20), nullable=False))
