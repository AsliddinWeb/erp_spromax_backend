...
@router.post("/shifts/{shift_id}/records/materials", response_model=ProductionRecordResponse, status_code=status.HTTP_201_CREATED)
...
@router.post("/shifts/{shift_id}/records/output", response_model=ProductionOutputResponse, status_code=status.HTTP_201_CREATED)
...
@router.post("/shifts/{shift_id}/records/defects", response_model=DefectiveProductResponse, status_code=status.HTTP_201_CREATED)
