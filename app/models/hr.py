from sqlalchemy import Column, String, ForeignKey, Numeric, DateTime, Date, Integer, Text
...
class LeaveRequest(BaseModel):
    ...
    employee_id = Column(UUID(as_uuid=True), ForeignKey('employees.id'), nullable=False)
    leave_type = Column(String(50), nullable=False)  # annual, sick, unpaid, maternity
